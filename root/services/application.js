...
angular.module('cricwormadmin').factory('applicationService', ['pluginsService', function (pluginsService) {
    ...
    function toggleSubmenuHover() {
             console.log("called menu toggle hover");
        if ($('body').hasClass('submenu-hover')) removeSubmenuHover();
        else createSubmenuHover();s
    }
